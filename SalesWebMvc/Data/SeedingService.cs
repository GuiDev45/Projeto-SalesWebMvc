        ...
        public static void Seed(IServiceProvider serviceProvider)
        {
            using (var context = new SalesWebMvcContext(
                serviceProvider.GetRequiredService<
                    DbContextOptions<SalesWebMvcContext>>()))
            {
                ...
                Seller s2 = new Seller("Maria Green", "maria@gmail.com", new DateTime(1979, 12, 21), 3500.0, d2);
                Seller s3 = new Seller("Alex Grey", "alex@gmail.com", new DateTime(1988, 1, 15), 2200.0, d1);
                Seller s4 = new Seller("Martha Red", "martha@gmail.com", new DateTime(1993, 11, 21), 3000.0, d4);
                Seller s5 = new Seller("Donald Blue", "donald@gmail.com", new DateTime(2000, 1, 21), 4000.0, d3);
